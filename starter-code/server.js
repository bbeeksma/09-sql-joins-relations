...
app.get('/articles', function(request, response) {
  ...
  client.query('SELECT ar.*, au.author, au."authorUrl" FROM articles ar JOIN authors au ON ar.author_id = au.author_id;')
...
app.post('/articles', function(request, response) {
  ...
  function queryThree(author_id) {
    client.query(
      ...
      [request.body.title,request.body.category,request.body.publishedOn,request.body.body], // DONE: Add the data from our new article, including the author_id, as data for the SQL query.
      function(err) {
        if (err) console.error(err);
